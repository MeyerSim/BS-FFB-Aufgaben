...
/**
 * The test class AutoTestStufe2.
 *
 * @author  (Bichler)
 * @version (2017)
 */
public class AutoTestStufe2
{
    ...
    @Test
    public void testFahrenOhneParameter()
    {
        autoStandard.tanken(2.5);
        assertEquals(50.0,autoStandard.fahren(),0.000001);
        assertEquals(0.0, autoStandard.getBenzinStand(), 0.000001);
        assertEquals(50.0,autoStandard.getKmStand(),0.000001);
    }
    
    @Test
    public void testFahrenBisTankLeerRueckgabe()
    {
        autoStandard.tanken(2.5);
        assertEquals(50.0,autoStandard.fahren(99999.9),0.000001);
        assertEquals(0.0, autoStandard.getBenzinStand(), 0.000001);
        assertEquals(50.0,autoStandard.getKmStand(),0.000001);
    }
